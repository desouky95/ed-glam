...
export const MainTable: ComponentStory<typeof InfoTable> = () => {
	...
	const headerTitle: HeaderTitle = () => (
		<InfoTableHeaderTitle>Explore Course Content</InfoTableHeaderTitle>
	);
	const headerSubTitle: HeaderSubTitle = () => (
		<InfoTableHeaderSubTitle>
			This Classroom has 12 lessons, 6 Posted so far!
		</InfoTableHeaderSubTitle>
	);
	const renderHeader: TableHeader = () => (
		<InfoTableHeader title={headerTitle} subTitle={headerSubTitle} />
	);
